...
using namespace Graphics::ModelBase;
...
void ModelBase::Append( PrimtiveMeshType Type, const Math::Matrix4& Transform )
{
    m_PrimitiveQueue[Type].push_back(Transform);
}

void ModelBase::Flush( GraphicsContext& Context )
{
